...
// // Updated category list to include Bombs and Gift Boxes
// const categories = [
//   'All', 
//   'Rockets', 
//   'Shots', 
...
// /* PRO TIP: If you want this list to update automatically, use this instead:
...
// Manually defining the categories to show only the ones you want
const categories = [
  'All', 
  'Rockets', 
  'Shots', 
...
export function Products() {
   ...
   * Otherwise, filter products where the category matches the selection.
   */
  const filteredProducts = selectedCategory === 'All'
    ? products
    : products.filter(product => product.category === selectedCategory);
