...
//   // Generate the product list text (no prices) for the WhatsApp link
...
// Updated import: Video instead of Image
  ...
  return (
    <div>
      ...
      <section className="relative h-[600px] overflow-hidden">
        ...
        {/* Content Container (relative z-10 to stay on top of video) */}
